    ...
    <Crud
      ...
      fields={[
        ...
        { key: "summary", label: "Resumen", type: "textarea" },
        {
          ...
          type: "textarea",
          rich: true,
          help: "Para un enlace: seleccioná el texto y tocá 🔗, o pegá la dirección (se vuelve clickeable sola).",
        },
        ...
        },
        {
          ...
          help: "Pegá el enlace de un posteo de Instagram, Twitter/X o YouTube y se muestra incrustado dentro de la noticia. La cuenta tiene que ser pública. Dejalo vacío si no querés incrustar nada.",
        },
        {
          key: "video",
          label: "Video de YouTube para la tarjeta (opcional)",
          placeholder: "https://www.youtube.com/watch?v=…",
          help: "Solo para la miniatura de la tarjeta en el portal. Para incrustar un video adentro de la nota, usá el campo de arriba.",
        },
